...
const Contact = () => {
  return (
    <section>
      ...
      <div className=" lg:p-[35px] bg-[##ffffff]  drop-shadow-sm border rounded-lg  dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className=' p-[32px]'>
          ...
          <div className='p-[35px]  lg:ml-[30px]    bg-[##ffffff] border  rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 '>
                          
          
        <div className="grid md:grid-cols-3 md:gap-6 ">
          <div className="relative z-0 w-full mb-5 group ">
            <input type="text" id="phone-input" aria-describedby="helper-text-explanation" class="bg-[#F5F5F5]  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4} placeholder:relative " placeholder="Your Name"  required /><small className="absolute top-1 left-28 text-red-300 text-3xl"> *</small>
          </div>
          <div className="relative z-0 w-full mb-5 group">
           
            <input type="text" id="phone-input" aria-describedby="helper-text-explanation" class="bg-[#F5F5F5]  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4} placeholder:relative" placeholder="Your Email " required /><small className="absolute top-1 left-28 text-red-300 text-3xl"> *</small>
          </div>
           <div className="relative z-0 w-full mb-5 group  ">
                 
            <input type="text" id="phone-input" aria-describedby="helper-text-explanation" class="bg-[#F5F5F5]  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4} placeholder:relative" placeholder="Your Phone" required /><small className="absolute top-1 left-28 text-red-300 text-3xl"> *</small>
            
          </div>
           </div>
                               
        <textarea id="message" rows={10}  className="block mt-8 p-2.5 lg:w-[737px] w-full text-sm text-gray-900  rounded-lg bg-[#F5F5F5] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-8" placeholder="Your Massage." defaultValue={""} />
